 ...
 * @author carlos
 */
@WebServlet(name = "ServletConsultarUsuarioIniciado", urlPatterns = {"/ServletConsultarUsuarioIniciado"})
public class ServletConsultarUsuarioIniciado extends HttpServlet {
