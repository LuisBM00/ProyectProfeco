 ...
 * @author carlos
 */
@WebServlet(name = "ServletReporteInconsistencias", urlPatterns = {"/ServletReporteInconsistencias"})
public class ServletReporteInconsistencias extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException, SQLException, JRException {
        ...
        File reportFile = new File(request.getServletContext().getRealPath("ListaArticulosXSuper/ReporteInconsistencias.jasper"));
